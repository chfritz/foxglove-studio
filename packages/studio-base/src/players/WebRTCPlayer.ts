...
// Connects to a roboto over a webrtc connection negotiated by Transitive Robotics
    ...
    listener({
      ...
      activeData: {
        ...
        topicStats: new Map([
          ['/myname', {
            numMessages: 1,
            firstMessageTime: fakeTime,
            lastMessageTime: fakeTime2,
          }]
        ]),
        datatypes: new Map(),
        // publishedTopics: this._publishedTopics,
